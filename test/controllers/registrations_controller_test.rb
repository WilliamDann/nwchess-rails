...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference("Registration.count") do
      post registrations_url, params: { registration: { registrationType: @registration.registrationType } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { registrationType: @registration.registrationType } }
